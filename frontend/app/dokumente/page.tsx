  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10 min-h-full">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 lg:mb-8">
        <div>
          <h1 className="text-2xl sm:text-[28px] font-semibold text-neutral-900 tracking-tight">Dokumente</h1>
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-xs text-neutral-400">
                          {format(new Date(doc.uploaded_at), 'dd.MM.yy', { locale: de })}
                        </span>
                      </div>
                    </div>
                  </div>
      ...
      {/* Pagination */}
      {data && data.pages > 1 && (
        <div className="flex justify-center gap-1 mt-4 lg:mt-6 flex-wrap">
